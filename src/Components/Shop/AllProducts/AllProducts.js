        ...
        <div className=" mb-3 mt-3 p-3 border-bottom" style={{ maxWidth: "100%", height: "auto" }}>
            <div className="row g-0">
                <div className="col-md-4 d-flex justify-content-center align-items-center">
                    {
                        pd.image.img ? <img style={{ maxWidth: "50%" }} src={`data:image/png;base64,${pd.image.img}`} className="img-fluid rounded-start" alt="..."/>
                        :<img style={{ maxWidth: "50%" }} src={pd.image} className="img-fluid rounded-start" alt="..." />
                    }
                </div>
                <div className="col-md-8 d-flex align-items-center">
                    <div className="card-body">
                        <h5 className="card-title"><Link to={`/product/${pd._id}`} >{pd.title}</Link></h5>
